            ...
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <button 
                  ...
                  className="w-6 h-6 bg-white/5 rounded-lg flex items-center justify-center text-gray-600 hover:text-[#ff8c00] active:scale-90 transition-all"
                  title="Đặt lại thống kê lợi nhuận"
                >
                  <RotateCcw size={12} />
                </button>
              </div>
              <h3 className="text-4xl font-black text-[#ff8c00] tracking-tighter">{loanProfit.toLocaleString()} <span className="text-lg">đ</span></h3>
            </div>
